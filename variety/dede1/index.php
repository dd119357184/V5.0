...
<div id="hd_main">
   ...
   <?php
    ...
    if(strpos($path,'/admin/')>-1){
	   echo '<div style="text-align:center; color:red; font-size:18px; margin-bottom:15px;">您的后台目录为默认的/admin/ ，为了安全请修改后台目录!!!!</div>';	
	}
	if($huoduan['admin_name']=='huoduan' && $huoduan['admin_pass']=='a13a02276910cbc879f020ed88816512'){
	   echo '<div style="text-align:center; color:red; font-size:18px; margin-bottom:15px;">您的账号密码为系统默认，请尽快修改</div>';	
  ...
  <tr>
    ...
    <td><span id="m_ver"><a href="http://www.huoduan.com/item/1001.html" target="_blank">V2.1</a></span></td>
  </tr>
  <tr>
    <td align="right">最新版本：</td>
    <td><span id="new_ver"><a href="http://www.huoduan.com/item/1001.html" target="_blank">V2.1</a></span></td>
  </tr>
  <tr>
...
<tr>
  ...
  <tr>
    <td colspan="2" style="line-height:220%; text-indent:28px;">搜虎精品社区www.souho.net提供源码，持续更新中，感谢您的支持！</td>
    </tr>
...
<!-- 检测新版本 -->
<script type="text/javascript" src="http://www.huoduan.com/app/web/so.php?c=update&ver=2.1&z=170124&new=1"></script>
</body>
</html>
