...
<html mip="#">
 <head>
  ...
  <title>影响力人物排行榜-全球最具权势人物-富豪人物排名-今日热点人物-中青创人物快搜</title>
  <meta name="keywords" content="世界著名人物排名榜,世界人物影响力排名,影响力人物,互联网人物风云榜" />
  <meta name="description" content="中青创人物大全，大量的电影榜单，电视榜单和人物榜单，为您揭晓全球最具影响力人物排行榜，以及权势，富豪等全球金融大佬财富排名。" />
  ...
  <link rel="canonical" href="http://db577.cn/character/" />
 </head>
 <body>
  <header class="header">
   ...
   <div class="wrapper">
    <section class="topic_list">
     <ul class="layout_ul">
	   ...
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="热点人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r1.jpg"></mip-img></a>
		  <h2><strong>最新热点人物</strong></h2>
         <div class="excerpt">
        中青创头条热点人物频道，总会有一些人成为网络上的热点搜索人物，下面我们来看看这些人物排名。
         </div>
         <div class="postinfo">
          <div class="left">
	     ...
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],258);
		 for($i=0;$i<30;$i++){
	 ...
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="名家人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r2.jpg"></mip-img></a>
		  <h2><strong>最新名家人物</strong></h2>
         <div class="excerpt">
        中青创头条名家人物频道，人物简介以及人物的生平大事，让我们一起了解活跃在历史中名人。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],260);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="公益人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r3.jpg"></mip-img></a>
		  <h2><strong>最新公益人物</strong></h2>
         <div class="excerpt">
        中青创头条公益人物频道，公益人物的人士来自各行各业，这其中也不乏娱乐圈里的一些艺人，比如说古天乐等。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
	 ...
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="财经人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r4.jpg"></mip-img></a>
		  <h2><strong>最新财经人物</strong></h2>
         <div class="excerpt">
        中青创头条财经人物频道，提供财经人物相关简历介绍和最新资讯，及最新最快最全面的财经大佬排行榜。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>453890</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],261);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="体坛人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r5.jpg"></mip-img></a>
		  <h2><strong>最新体坛人物</strong></h2>
         <div class="excerpt">
        中青创头条体坛人物频道，他们用自己的行动，向世界证明了中国正在成长，都值得让我们学习。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],255);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="主持人">
          <mip-img layout="container" src="http://db577.cn/style/images/r6.jpg"></mip-img></a>
		  <h2><strong>最新主持人</strong></h2>
         <div class="excerpt">
        中青创头条主持人频道，是指具有采、编、播、控等多种业务能力，在一个相对固定的节目的个人。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>731028</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],454);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="历史人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r7.jpg"></mip-img></a>
		  <h2><strong>最新历史人物</strong></h2>
         <div class="excerpt">
        中青创头条历史人物频道，悠悠千古事是中国历史网，主要搜集中国历史人物等历史知识。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>834609</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],259);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="互联网人物">
          <mip-img layout="container" src="http://db577.cn/style/images/r8.jpg"></mip-img></a>
		  <h2><strong>最新互联网人物</strong></h2>
         <div class="excerpt">
        中青创头条互联网人物频道，行业商业领袖的创业和管理案例，为中小企业创业者提供管理思路。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>638286</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],257);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="女明星">
          <mip-img layout="container" src="http://db577.cn/style/images/r9.jpg"></mip-img></a>
		  <h2><strong>最新女明星</strong></h2>
         <div class="excerpt">
        中青创头条女明星频道，最有魅力女明星的集中地，有时尚风姿的维密天使，性感迷人的艺术照。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],1570);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="男明星">
          <mip-img layout="container" src="http://db577.cn/style/images/r10.jpg"></mip-img></a>
		  <h2><strong>最新男明星</strong></h2>
         <div class="excerpt">
        中青创头条男明星频道，具有较高知名度和优秀艺术作品的男明星，到底谁才你心中最帅的那位？
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],1569);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="欧美明星">
          <mip-img layout="container" src="http://db577.cn/style/images/r11.jpg"></mip-img></a>
		  <h2><strong>最新欧美明星</strong></h2>
         <div class="excerpt">
        中青创头条欧美明星频道，走在世界流行尖端的欧美明星，高街，时尚，酷感十足，也一直是潮流风向标。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],491);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
