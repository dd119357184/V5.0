...
define('a', '搜虎精品社区www.souho.net提供源码，持续更新中，感谢您的支持！');//此信息不影响程序正常使用，请勿修改此处信息，修改后程序肯定会出错，因修改此信息引起的错误，将不提供任何技术支持
...
$huoduan['path'] = rtrim(dirname($_SERVER["SCRIPT_NAME"]), '/\\') .'/';
...
if((strpos($myurl,'`') || strpos($myurl,'\\') ) || (strlen($myurl)>70) &&  strpos($myurl,',') &&  strpos($myurl,'%')){
	echo 'Url Error';exit;
}
