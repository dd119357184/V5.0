...
<html mip="#">
 <head>
  ...
  <title>精致品质生活-值得去的景点-适合旅游的城市-博物馆排名-中青创品味生活快搜</title>
  <meta name="keywords" content="旅游城市,风景名胜,博物馆,宠物,小吃,畅销书,高校,奢侈品" />
  <meta name="description" content="中青创品味生活，表示人们日常生活的品位和质量，包括经济生活品质，文化生活品质，政治生活品质，社会生活品质，环境生活品质等五大品质。" />
  ...
  <link rel="canonical" href="http://db577.cn/life/" />
 </head>
 <body>
  <header class="header">
    ...
    <section class="topic_list">
     <ul class="layout_ul">
	   ...
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="旅游城市">
          <mip-img layout="container" src="http://db577.cn/style/images/h2.jpg"></mip-img></a>
		  <h2><strong>最新旅游城市</strong></h2>
         <div class="excerpt">
        中青创头条旅游城市频道，景点为核心，以旅游产业为主体，旅游业产值超过城市GDP的7%的一类城市。
         </div>
         <div class="postinfo">
          <div class="left">
	     ...
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],302);
		 for($i=0;$i<30;$i++){
	 ...
	 ?></ul>
      ...
      <li class="layout_li">
	   ...
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="风景名胜">
          <mip-img layout="container" src="http://db577.cn/style/images/h3.jpg"></mip-img></a>
		  <h2><strong>最新风景名胜</strong></h2>
         <div class="excerpt">
        中青创头条风景名胜频道，具有观赏的自然景观，人文景观比较集中,环境优美,可供人们游览。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],14);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="博物馆">
          <mip-img layout="container" src="http://db577.cn/style/images/h4.jpg"></mip-img></a>
		  <h2><strong>最新博物馆</strong></h2>
         <div class="excerpt">
        中青创头条博物馆频道，有科学性，历史性或者艺术价值的物品进行分类，为公众提供知识。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>954687</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],1579);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="宠物">
          <mip-img layout="container" src="http://db577.cn/style/images/h5.jpg"></mip-img></a>
		  <h2><strong>最新宠物</strong></h2>
         <div class="excerpt">
        中青创头条宠物频道，指人们为了消除孤寂或出于娱乐目的而豢养的动物。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>453890</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],24);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="小吃">
          <mip-img layout="container" src="http://db577.cn/style/images/h6.jpg"></mip-img></a>
		  <h2><strong>最新小吃</strong></h2>
         <div class="excerpt">
        中青创头条小吃频道，口味上具有特定风格特色的食品，能够突出反映当地的物质文化及社会生活风貌。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],1434);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="畅销书">
          <mip-img layout="container" src="http://db577.cn/style/images/h7.jpg"></mip-img></a>
		  <h2><strong>最新畅销书</strong></h2>
         <div class="excerpt">
        中青创头条畅销书频道，有意义的那些书是值得反思的，我个人的观点是畅销书一定是好书。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>731028</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],450);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="高校">
          <mip-img layout="container" src="http://db577.cn/style/images/h8.jpg"></mip-img></a>
		  <h2><strong>最新高校</strong></h2>
         <div class="excerpt">
        中青创头条高校频道，是由国家教育部或省级教育行政部门主管的，实行高等教育的学校。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>834609</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],12);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="奢侈品">
          <mip-img layout="container" src="http://db577.cn/style/images/h9.jpg"></mip-img></a>
		  <h2><strong>最新奢侈品</strong></h2>
         <div class="excerpt">
        中青创头条奢侈品频道，在生活当中，奢侈品牌享有很特殊的市场和很高的社会地位。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>638286</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],270);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="慈善公益">
          <mip-img layout="container" src="http://db577.cn/style/images/h10.jpg"></mip-img></a>
		  <h2><strong>最新慈善公益</strong></h2>
         <div class="excerpt">
        中青创头条慈善公益频道，为人民服务的一种通俗讲法，指有关社会公众的福祉和利益。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],367);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
       ...
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="化妆品">
          <mip-img layout="container" src="http://db577.cn/style/images/h11.jpg"></mip-img></a>
		  <h2><strong>最新化妆品</strong></h2>
         <div class="excerpt">
        中青创头条化妆品频道，保护皮肤的产品，现如今护肤品已走进了平常百姓家。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
		   ...
		   <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],1565);
		 for($i=0;$i<30;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
