...
<html mip="#">
 <head>
  ...
  <title>中青创搜索-专注于分享热点事件-看新闻看资讯就上中青创头条</title>
  <meta name="keywords" content="中青创头条,热点阅读网,最新热点资讯,热点新闻,社会热点事件" />
  <meta name="description" content="中青创头条是包含海量资讯的新闻阅读平台,真实反映每时每刻发生的热点事件，让您快速了解事件的最新动态，24小时滚动报道国内，国际及社会新闻，看新闻就上中青创头条" />
  ...
  <link rel="canonical" href="http://db577.cn/" />
 </head>
 <body>
  <header class="header">
    ...
    <section class="wrapper">
     <nav class="header_menu">
      <ul class="menu">
       ...
       <li><a href="https://www.xiaoxiaoyou.cn/" data-type="mip" data-title="说说" title="说说">说说</a></li>
       <li></li>
      </ul>
     </nav>
    ...
    <section class="topic_list">
     <ul class="layout_ul">
      <li class="layout_li">
	   ...
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="实时热点">
          <mip-img layout="container" src="http://db577.cn/style/images/1.jpg"></mip-img></a>
		  <h2><strong>最新实时热点</strong></h2>
         <div class="excerpt">
        中青创头条实时热点频道，为您提供了社会新闻，实时热点，实时热点新闻，实时热点排行榜，社会热点等。
         </div>
         <div class="postinfo">
          <div class="left">
	 ...
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="今日热点">
          <mip-img layout="container" src="http://db577.cn/style/images/2.jpg"></mip-img></a>
		  <h2><strong>最新今日热点</strong></h2>
         <div class="excerpt">
        中青创头条今日热点频道，呈现最新鲜的热门话题新闻视频，有趣生活小百科，国内外的热门新鲜事一网打尽。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>954687</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],341);
		 for($i=0;$i<42;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="七日热点">
          <mip-img layout="container" src="http://db577.cn/style/images/3.jpg"></mip-img></a>
		  <h2><strong>最新七日热点</strong></h2>
         <div class="excerpt">
        中青创头条七日热点频道，为您一站式解读最新最热的人事物信息，引领热词阅读时代，汇聚一周热点事件等。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>453890</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],42);
		 for($i=0;$i<42;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="娱乐热点">
          <mip-img layout="container" src="http://db577.cn/style/images/4.jpg"></mip-img></a>
		  <h2><strong>最新娱乐热点</strong></h2>
         <div class="excerpt">
        中青创头条娱乐热点频道，娱乐圈娱乐热点提供了实时热点人物事件，国内外明星的八卦爆料等最新热门资讯。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>731028</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],344);
		 for($i=0;$i<42;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="人物热点">
          <mip-img layout="container" src="http://db577.cn/style/images/5.jpg"></mip-img></a>
		  <h2><strong>最新民生热点</strong></h2>
         <div class="excerpt">
        中青创头条民生热点频道，为您一站式解读最新最热的人事物信息，引领热词阅读时代，关注民生了解民生。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>834609</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],342);
		 for($i=0;$i<42;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
	 ?></ul>
      ...
      <li class="layout_li">
       <article class="topic_main">
	   <section class="topic_post">
	   <a target="_blank" href="#" rel="bookmark" class="thumbs" title="体育热点">
          <mip-img layout="container" src="http://db577.cn/style/images/6.jpg"></mip-img></a>
		  <h2><strong>最新体育热点</strong></h2>
         <div class="excerpt">
        中青创头条体育热点频道，提供最专业的体育新闻和赛事报道，主要有以下栏目:中国足球、国际足球、篮球、NBA等。
         </div>
         <div class="postinfo">
          <div class="left">
           <span class="author"><a href="#" ><i class="icon icon-user-1"></i>中青创小编</a></span>
          ...
          <div class="right">
           <span class="view"><i class="icon icon-eye-1"></i><b>638286</b></span>
		    ...
		    <ul class="middle-text1"> <?php 
	     $topkey = huoduan_get_baidu_top($huoduan['hotcachetime'],11);
		 for($i=0;$i<42;$i++){
			 if(strlen($topkey[$i])>0){
			echo ' <li><span class="num'.$numclass.'"></span><a target="_blank" href="'.huoduansourl($topkey[$i]).'">'.$topkey[$i].'</a></li>'; 	} 
		 }
 ...
 <?php
$url = "http://links.520link.com/link/links?id=19231&url=db577.cn&type=显式格式&css=样式"; 
$bm="utf-8";
$contents = file_get_contents($url); 
$contents =urldecode($contents);
$contents =iconv("utf-8", $bm,$contents);
echo $contents; 
?>
</p>
   <p class="middle-text">
