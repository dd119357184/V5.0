...
<html mip>
 <head>
  ...
  <link rel="canonical" href="http://db577.cn/<?php echo $q?>.html" />
    ...
    <section class="content">
     <section class="content_left home">
      <mip-vd-tabs allow-scroll="">
	   ...
	   <p>中青创头条资讯的小青青今天给大家整理了一篇有关<?php echo $q?>的聚合阅读列表，更多<?php echo $q?>的详细内容，欢迎点击下方阅读列表，获取更多内容信息，爱上阅读就上中青创头条网。</p>
	   <mip-img layout="container" alt="<?php echo $q?>" src="http://db577.cn/style/images/wc.jpg"></mip-img></div>
 <?php
if($listcount>1&& $kill!=1){
  ...
  for($i=0;$i<$listcount;$i++){
	  ...
	  if($kurl!=1 && strlen($list['data'][$ni]['title'])>0 ){
		...
		?>
	<h2><?php if($huoduan['listnum']==1){?><span class="nums"><?php echo $listnum[$ii]?></span> <?php }?><a href="http://db577.cn<?php echo $sourl?>" target="_blank" class="s" rel="nofollow">[点击阅读]<?php echo $list['data'][$ni]['title']?></a></h2><div class="excerpt"><?php echo date("Y-m-d H:i",time()); ?> 描述：<?php echo $list['data'][$ni]['des']?> 来源：<?php echo huoduan_msubstr($blink,0,60);?></div>
		<?php	
	  }
  }
  echo '';
